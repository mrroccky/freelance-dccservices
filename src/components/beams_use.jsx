...
export default function BeamsUse({ title, description }) {
  return (
    (<div
      className="h-[40rem] w-full rounded-md bg-white relative flex flex-col items-center justify-center antialiased">
